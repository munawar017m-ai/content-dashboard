(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_f24d50dc._.js",
...
var supabase;
function createClientComponentClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://vpghmxcvtcnybdvcbtql.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwZ2hteGN2dGNueWJkdmNidHFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyMzIxNTksImV4cCI6MjA3OTgwODE1OX0.fpJTWTjtdjXhQgcnQ39vMYeBil-ry8QRh7nC-aEhpmg"), options, cookieOptions, isSingleton = true } = {}) {
...
function createPagesServerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vpghmxcvtcnybdvcbtql.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwZ2hteGN2dGNueWJkdmNidHFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyMzIxNTksImV4cCI6MjA3OTgwODE1OX0.fpJTWTjtdjXhQgcnQ39vMYeBil-ry8QRh7nC-aEhpmg"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createMiddlewareClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vpghmxcvtcnybdvcbtql.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwZ2hteGN2dGNueWJkdmNidHFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyMzIxNTksImV4cCI6MjA3OTgwODE1OX0.fpJTWTjtdjXhQgcnQ39vMYeBil-ry8QRh7nC-aEhpmg"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createServerComponentClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vpghmxcvtcnybdvcbtql.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwZ2hteGN2dGNueWJkdmNidHFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyMzIxNTksImV4cCI6MjA3OTgwODE1OX0.fpJTWTjtdjXhQgcnQ39vMYeBil-ry8QRh7nC-aEhpmg"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createRouteHandlerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vpghmxcvtcnybdvcbtql.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwZ2hteGN2dGNueWJkdmNidHFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyMzIxNTksImV4cCI6MjA3OTgwODE1OX0.fpJTWTjtdjXhQgcnQ39vMYeBil-ry8QRh7nC-aEhpmg"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://vpghmxcvtcnybdvcbtql.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwZ2hteGN2dGNueWJkdmNidHFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyMzIxNTksImV4cCI6MjA3OTgwODE1OX0.fpJTWTjtdjXhQgcnQ39vMYeBil-ry8QRh7nC-aEhpmg"), options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vpghmxcvtcnybdvcbtql.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwZ2hteGN2dGNueWJkdmNidHFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyMzIxNTksImV4cCI6MjA3OTgwODE1OX0.fpJTWTjtdjXhQgcnQ39vMYeBil-ry8QRh7nC-aEhpmg"), options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vpghmxcvtcnybdvcbtql.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwZ2hteGN2dGNueWJkdmNidHFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyMzIxNTksImV4cCI6MjA3OTgwODE1OX0.fpJTWTjtdjXhQgcnQ39vMYeBil-ry8QRh7nC-aEhpmg"), options, cookieOptions } = {}) {
...
//# sourceMappingURL=node_modules_f24d50dc._.js.map